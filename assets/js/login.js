    ...
    Kakao.API.request({
        ...
        success: function (response) {
            if (isUser(PLATFORM_TYPE_KAKAO, response.id)) {
                ...
                kakaoResponse.birthday = response.kakao_account.birthday;
                ...
                let registerHtml = `    
                    <div class="sectionTitle text-center register-box mt-3">
                        <div class="title">
                            <h1>
                                <span class="text-primary">쿠폰메이트</span>에 오신 것을 환영합니다
                            </h1>
                        </div>
                    </div>
                    ...
                    <form id="registerForm">
                        ...
                        <div class="form-group row pl-1" id="auth-number-input" style="display: none">
                         ...
                         <div class="form-group">
                            <input class="form-control" name="birthday" placeholder="생일을 입력해주세요" type="text" value="${kakaoResponse.birthday}">
                        </div>
                        <div class="form-group">
